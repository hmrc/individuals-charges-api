...
package v3.retrieve.def2.fixture

import play.api.libs.json.{JsValue, Json}
import v3.retrieve.def2.model.response._
import v3.retrieve.model.response._
...
object RetrievePensionChargesFixture {
  ...
  val retrieveResponse: RetrievePensionChargesResponse = Def2_RetrievePensionChargesResponse(
