...
import v3.createAmend.def1.model.Def1_CreateAmendPensionChargesValidator
import v3.createAmend.def1.model.request.{Def1_CreateAmendPensionChargesRequestBody, Def1_CreateAmendPensionChargesRequestData}
import v3.createAmend.model.request.CreateAmendPensionChargesRequestData

class Def1_CreateAmendPensionChargesValidatorSpec extends UnitSpec {
