  ...
  "calling .buildPredicate" when {
    "confidence level checks are on" should {
      "return a Predicate containing confidence level 200 on top of the provided Predicate" when {
        ...
        "always return confidence level 200 regardless of configuration confidence level" in new Test {
          mockConfidenceLevelCheckConfig(confidenceLevel = ConfidenceLevel.L250)
