...
object DownstreamUri {
  ...
  def IfsUri[Resp](path: String)(implicit appConfig: SharedAppConfig): DownstreamUri[Resp] =
    DownstreamUri(path, DownstreamStrategy.standardStrategy(appConfig.ifsDownstreamConfig))
