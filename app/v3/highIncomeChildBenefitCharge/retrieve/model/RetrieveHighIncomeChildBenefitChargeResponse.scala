...
object RetrieveHighIncomeChildBenefitChargeResponse {
  implicit val format: OFormat[RetrieveHighIncomeChildBenefitChargeResponse] = Json.format[RetrieveHighIncomeChildBenefitChargeResponse]
}
