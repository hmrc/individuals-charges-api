...
@Singleton
class DeleteHighIncomeChildBenefitChargeValidatorFactory @Inject() {

  def validator(nino: String, taxYear: String): Validator[DeleteHighIncomeChildBenefitChargeRequestData] =
