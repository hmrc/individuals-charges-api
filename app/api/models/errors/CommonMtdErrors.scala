...
// API Specific Errors
object RuleWFPAmountAboveMaximumError
    extends MtdError("RULE_WFP_AMOUNT_ABOVE_MAXIMUM", "Amount exceeds the maximum Winter Fuel Payment for the tax year", BAD_REQUEST)

object RuleWFPAmountBelowMinimumError
    extends MtdError("RULE_WFP_AMOUNT_BELOW_MINIMUM", "Amount is below the minimum Winter Fuel Payment for the tax year", BAD_REQUEST)
