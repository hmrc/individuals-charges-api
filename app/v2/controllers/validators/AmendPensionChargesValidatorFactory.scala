...
import v2.controllers.validators.AmendPensionChargesRulesValidator.validateBusinessRules
    ...
    new Validator[CreateAmendPensionChargesRequestData] {
      ...
      def validate: Validated[Seq[MtdError], CreateAmendPensionChargesRequestData] =
        (
          ...
          resolveJson(body)
        ).mapN(CreateAmendPensionChargesRequestData) andThen validateBusinessRules
